...
namespace Properties_Example
{
    ...
    -We make fields of the class private, so that fields can't be accessed from outside the class directly. 
     Now we are forced to use C# properties for setting or getting values.
   */

    #region C# Properties Example 1
    ...
    #region C# Properties Example 2: having logic while setting value
    //public class Employee
    //{
    //    private string name;
    ...
    #region C# Properties Example 3: Read-only property
    public class Employee
    {
